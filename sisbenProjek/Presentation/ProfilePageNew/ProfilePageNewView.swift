...
var mockProfile: ProfileItem = ProfileItem(image: "person.fill", title: "User Profile", subTitle: "Edit Profile", bgColor: WWColor.purplePastel, fgColor: WWColor.purpleSoft)
...
struct ProfilePageNewView: View {
...
struct ProfilePageNewView_Previews: PreviewProvider {
