...
struct PrimaryButtonStyle: ButtonStyle {
    ...
    func makeBody(configuration: Self.Configuration) -> some View {
        ...
        return configuration.label
            ...
            .font(WWFont.bold(size: 16))
            .shadow(color: WWColor.black.opacity(0.25), radius: 4, x: 0, y: 4)
    }
}
...
struct PrimaryButton: View {
    ...
    init(title: String,
         disabled: Bool = false,
         backgroundColor: Color = WWColor.purpleSoft,
         foregroundColor: Color = WWColor.white,
         strokeColor: Color = WWColor.purpleSoft,
